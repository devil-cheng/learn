var _excluded = ["format", "className", "tips", "maxLength", "highlight"];
...
var TextArea = function TextArea(_ref, ref) {
  ...
  }, /*#__PURE__*/React.createElement(AntdTextArea, _extends({
    className: classnames(className, tips && "".concat(prefixCls, "-input")),
    ref: ref,
  ...
  }, tips && /*#__PURE__*/React.createElement(Tips, _extends({
    prefixCls: prefixCls,
    format: format,
