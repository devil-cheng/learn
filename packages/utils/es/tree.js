...
export function createTreeFromTreeLikeArray(array, options) {
  var _ref = options || {},
...
export function filterTreeArray(array, predicate, options) {
  var _ref2 = options || {},
...
export function closestParentItemInTreeArray(array, node) {
...
export function closestParentKeysInTreeArray(array, key) {
  var depth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var options = arguments.length > 3 ? arguments[3] : undefined;
...
export function findChildrenItemInTreeArray(array, targetNode, options) {
  var _ref5 = options || {},
...
export function hasChildrenNode(array, targetNode, options) {
  var _ref6 = options || {},
...
export function getTreeNodeByPath(tree, path) {
...
export function getFromTree(tree, path) {
...
export function setToTree(tree, path, value) {
  var pathArray = _normalizeObjectPath(path);
...
export function flattenTree(tree) {
  ...
  var treeDataClone = tree ? cloneDeep(tree) : null;
...
export function traverseTree(tree, callbackFn) {
...
export function someTree(tree, predicate) {
  var traverseType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : TraverseType.Breath;
  var options = arguments.length > 3 ? arguments[3] : undefined;
...
export function everyTree(tree, predicate) {
  var traverseType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : TraverseType.Breath;
  var options = arguments.length > 3 ? arguments[3] : undefined;
  return _traverse(tree, predicate, traverseType === TraverseType.Depth ? 'unshift' : 'push', Object.assign(Object.assign({}, options), {
    every: true,
...
export function findOneInTree(tree, predicate) {
  var traverseType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : TraverseType.Breath;
  var options = arguments.length > 3 ? arguments[3] : undefined;
...
export function findAllInTree(tree, predicate) {
  var traverseType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : TraverseType.Breath;
  var options = arguments.length > 3 ? arguments[3] : undefined;
...
export function findParentTreeNode(tree, targetNode, options) {
  var _ref10 = options || {},
...
export function findIndexInSiblingNode(tree, targetNode, options) {
  var _ref11 = options || {},
...
export function findSiblingNodes(tree, targetNode, options) {
  var _ref12 = options || {},
...
export function mapTree(tree, callbackFn, options) {
  var _ref13 = options || {},
      _ref13$childrenKey = _ref13.childrenKey,
      childrenKey = _ref13$childrenKey === void 0 ? 'children' : _ref13$childrenKey;

  var treeClone = tree instanceof Array ? cloneDeep(tree) : [cloneDeep(tree)];
...
export function mapTreeWithParent(tree, callbackFn, parentNode, options) {
  var _ref14 = options || {},
...
export function replaceTreeNode(tree, predicate, replaceNode) {
...
export function removeEmptyChildrenTreeNode(tree, options) {
  var _ref16 = options || {},
...
export function statisticsTreeNodeChildren(tree) {
...
export function closestParentItemInTree(tree, predicate) {
...
export function findAllChildrenInTree(tree, predicate, options) {
  var _a;
...
export function filterTree(tree, predicate, options) {
  ...
  return cloneDeep(tree).filter(function (child) {
    if (child[childrenKey]) {
...
export function filterTreeWithParentNode(tree, predicate, parentNode, options) {
  var _ref21 = options || {},
...
export function completionTreeNodePid(tree, options) {
  var _ref22 = options || {},
  ...
  var treeDataClone = cloneDeep(tree);
...
export function getRightNode(tree, targetNode, options) {
  var _a;
...
export function getAllRightNode(tree, targetNode, options) {
  var _ref24 = options || {},
...
export function getLeftNode(tree, targetNode, options) {
  var _a;
...
export function getAllLeftNode(tree, targetNode, options) {
  var _ref26 = options || {},
...
export function removeEmptyChildren() {
  ...
  return Array.isArray(tree) ? cloneDeep(tree).map(function (item) {
...
export function effectSubNode() {
  ...
  return cloneDeep(tree).map(function (item) {
    var result = Object.assign({}, item);
